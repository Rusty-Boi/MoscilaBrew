            ...
            <div class="container-lg border" style="width: 37rem; background: rgba(239, 195, 164, 0.4);border-radius: 8;">
                <div class="row d-flex">
                    <div class="col-3 border-end border-black px-0" style="margin: 1rem;">
                        <img src="{{  asset('img/bank/mandiri.png')}}" style="width: 9rem; margin-top: 1rem; margin-left: rem;"
                            alt="">
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <a href="{{ route('dashboard') }}"><button type="button" class="btn btn-secondary" style="background-color: rgba(239, 195, 164, 0.4); "><span style="color: black;" >Kembali ke halaman utama</span></button></a>
