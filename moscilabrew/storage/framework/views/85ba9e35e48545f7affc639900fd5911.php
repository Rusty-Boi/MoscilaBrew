                    ...
                    <div class="row mt-2 justify-content-center align-items-center beans-chooser">
                        ...
                        <div class="col-4 bean-chooser mt-auto">
                            ...
                            <div class="card p-3 primaryBean">
                                ...
                                <input type="number" class="form-control visually-hidden bean_id" name="base_bean">
                                                ...
                                                <div class="modal-body d-flex flex-column">
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Bean Name"
                                                            aria-label="baseBean" aria-describedby="addon-wrapping">
                                                    </div>
...
<div class="card p-3 primaryBean">
    ...
    <input type="number" class="form-control visually-hidden bean_id" name="primary_bean">
    ...
    <div class="row justify-content-center align-items-center mt-4">
        <h3 class="mb-0">Primary Bean</h3>
            ...
            <div class="card p-3 primaryBean">
                ...
                <input type="number" class="form-control visually-hidden bean_id" name="secondary_bean">
