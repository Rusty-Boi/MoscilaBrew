    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      <li class="nav-item">
        <a href="/seller/dashboard" class="nav-link <?php echo e((request()->is('seller/dashboard')) ? 'active' : ''); ?> py-3 border-bottom rounded-0" aria-current="page" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Home" data-bs-original-title="Home">
          ...
          <!-- <img src="<?php echo e(asset('img/seller-icon/house-chimney-solid.svg')); ?>" width="40" height="40" > -->
...
<!-- end of sidebar --><?php /**PATH C:\Users\Admin\Documents\GitHub\MoscilaBrew\moscilabrew\resources\views/layouts/sidebar-seller.blade.php ENDPATH**/ ?>