                    ...
                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-desertSand-30 rounded-4 mt-3" >
                            ...
                            <div class="container d-flex justify-content-between py-2">
                                <div>
                                    <p class="mb-0"><?php echo e($transaction['vendor-name']); ?></p>
                        ...
                        <div class="row gy-2">
                            <?php $__currentLoopData = $transaction['product-items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-12">
                                    <div class="card border border-0">
                                        <div class="card-body px-0">
                                            ...
                                            <p class="card-text">
                                                <img class="mb-2" src="<?php echo e($item['product-img']); ?>" alt="">
                                                <br>
                                                Total
                                                <span class="rounded-3 py-2 px-5 mx-2 bg-desertSand-30"><?php echo e($item['qty']); ?></span>
                                                Pouch
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col d-flex justify-content-between fw-bold">
                                    ...
                                    <p>
                                    <?php echo e($item['qty']); ?> x <?php echo e($item['price']); ?> = Rp. 180.000
                                    </p>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ihsan\Documents\GitHub\MoscilaBrew\moscilabrew\resources\views/confirmation-buy.blade.php ENDPATH**/ ?>