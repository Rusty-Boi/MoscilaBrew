                ...
                <div class="col-7">
                    <a class="card vendor-card rounded-4 text-decoration-none" href="#">
                        ...
                        <div class="card-body p-2">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title vendor-name mb-0"><?php echo e($vendor['vendor-Name']); ?></h5>
                                    <p class="card-text partner-status">
                                        <?php echo e($vendor['partner-status']); ?>

                                        <img class="m-0 vendor-img"
                                            src=<?php echo e(asset($partners_status_img[$vendor['partner-status']])); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\MoscilaBrew\moscilabrew\resources\views/confirmation-buy-custom-blend.blade.php ENDPATH**/ ?>