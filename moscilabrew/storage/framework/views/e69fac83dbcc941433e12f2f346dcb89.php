<nav class="navbar navbar-expand-lg bg-grey vh-20 fixed-top">
                  ...
                  <button onclick="cartNav()" class="btn" type="button" id="cart">
                      <div class="dropdown border-top ">
                          ...
                          <ul class="dropdown-menu text-small shadow dropdown-menu-end" aria-labelledby="dropdownUser3">
                            <li><a class="dropdown-item" href="<?php echo e(route('dashboard')); ?>">Kembali ke MoscilaBrew</a></li>
                          </ul>
                        </div>
                  </button>
              </div>
  ...
  </nav><?php /**PATH D:\Project\MoscilaBrew\moscilabrew\resources\views/layouts/header-seller.blade.php ENDPATH**/ ?>