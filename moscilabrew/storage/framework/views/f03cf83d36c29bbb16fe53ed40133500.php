...
<?php $__env->startSection('bodyClass', 'coffeeBlendChooserPage'); ?>
                            ...
                            <div class="card p-3 primaryBean">
                                <div class="row p-3 justify-content-center align-items-center">
                                    <img class="rounded bean_image" alt="./Assets/noimage.jpg"
                                        src="<?php echo e(asset('img/noimage.jpg')); ?>">
                                </div>

                                <input type="number" class="form-control visually-hidden bean_id" name="base_bean" value=<?php echo e(old('base_bean')); ?>>
                                                        ...
                                                        <?php $__currentLoopData = $coffees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coffee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <button type="button"
                                                                ...
                                                                <input type="number" class="form-control visually-hidden"
                                                                    aria-describedby="helpId" value="<?php echo e($coffee->id); ?>">
                                                                <div class="container">
                                                                    <div
                                                                        ...
                                                                        <div class="col-2 p-0 px-2">
                                                                            <img class="img-fluid h-auto"
                                                                                src="<?php echo e(asset($coffee->product_img)); ?>"
                                                                                alt="">
                                                                        </div>
                                                                        <div class="col p-2">
                                                                            <h5 class="p-0 m-0"><?php echo e($coffee->product_name); ?>
...
<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/bean-chooser.css')); ?>">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('js'); ?>
    <script>
        var coffees = <?php echo $coffees; ?>
...
<div class="card p-3 primaryBean">
    ...
    <input type="number" class="form-control visually-hidden bean_id" name="primary_bean" value=<?php echo e(old('primary_bean')); ?>>
                            ...
                            <button type="button"
                                ...
                                <div class="container">
                                    <div
                                        ...
                                        <div class="col p-2">
                                            <h5 class="p-0 m-0"><?php echo e($coffee->product_name); ?></h5>
                                        </div>
                                    </div>
                                </div>
                            </button>
    ...
    <div class="row justify-content-center align-items-center mt-4">
        <h3 class="mb-0">Primary Bean</h3>
            ...
            <div class="card p-3 primaryBean">
                ...
                <input type="number" class="form-control visually-hidden bean_id" name="secondary_bean" value=<?php echo e(old('secondary_bean')); ?>>
                                ...
                                <div class="modal-body d-flex flex-column">
                                    ...
                                    <div class='bean-options'>
                                        ...
                                        <button type="button" class="btn p-0 m-0 text-start w-100 bean_option_btn" data-bs-dismiss="modal">
                                            <input type="number" class="form-control visually-hidden" aria-describedby="helpId" value="<?php echo e($coffee->id); ?>">
                                            <div class="container">
                                                <div
                                                class="row d-flex flex-row p-0 searchResult align-items-center justify-content-start">
                                                <div class="col-2 p-0 px-2">
                                                    <img class="img-fluid h-auto" src="<?php echo e(asset($coffee->product_img)); ?>"
                                                        alt="">
                                                </div>
                                                <div class="col p-2">
                                                    <h5 class="p-0 m-0"><?php echo e($coffee->product_name); ?></h5>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ihsan\Documents\GitHub\MoscilaBrew\moscilabrew\resources\views/coffee-blend/index.blade.php ENDPATH**/ ?>