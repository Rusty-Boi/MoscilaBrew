                            ...
                            <div class="dropdown">
                                <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <?php if(Auth::user()->picture): ?>
                                        <img src="<?php echo e(Auth::user()->picture); ?>" alt="" style="width: 2rem">
                                    <?php else: ?>
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="<?php echo e(route('daftar-transaksi')); ?>">Daftar Transaksi</a></li>
                                  <li><a href="<?php echo e(route('profile.index')); ?>" class="btn profile dropdown-item" type="button" id="userProfile">Setting</a></li>
